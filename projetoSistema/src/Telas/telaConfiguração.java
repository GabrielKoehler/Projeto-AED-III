 ...
 * @author leticiam
 */
public class telaConfiguração extends javax.swing.JFrame {

    /**
     * Creates new form telaConfiguração
     */
    public telaConfiguração() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaConfiguração.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telaConfiguração().setVisible(true);
            }
        });
    }
